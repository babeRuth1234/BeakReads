...
// let labCode = false
// function validateKEycdoe(){
//     const code = document.getElementById('pathe');
//     const properCode = code.value;
//     const lengthRegex = /.{6,}/;
//     if(!lengthRegex.test(properCode)){
//        labCode= false
//     }else{
...
//     }
// }
// setInterval(validateKEycdoe, 100);
